        ...
        <div className="pb-32 lg:pb-8">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-8">
                    ...
                    <div className="glass-panel p-6 rounded-3xl border border-slate-800/50">
                        ...
                        <div className="mt-4 flex items-center gap-3 text-slate-500 text-[11px] font-mono uppercase tracking-wider">
                           <div className="w-1.5 h-1.5 rounded-full bg-primary/40 animate-pulse" />
                           KI-Schreibassistent aktiv
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2">
                            {(showAllGenres ? sortedGenres : sortedGenres.slice(0, BEST_OF_COUNT)).map(g => (
                                ...
                                >
                                    <h4 className={`text-xs font-bold uppercase tracking-tight ${genre === g.value ? 'text-primary' : 'text-slate-300'}`}>{g.label}</h4>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <button 
                                        ...
                                        className="w-full flex items-center justify-between p-2 text-[10px] uppercase font-bold text-slate-500 hover:text-slate-400"
                                    >
